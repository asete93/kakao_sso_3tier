...
public class KakaoLoginController {
    ...
    @GetMapping("/")
    public ResponseEntity<CustomMap> KakaoOauthLogin(@RequestParam String code){
        ...
        try {
            ...
            ResponseCookie accessCookie = ResponseCookie.from("access_token", access_token)
                    ...
                    .domain("localhost")
                    .path("/")
                    .maxAge(jwtTokenService.ACCESS_TOKEN_TIME_MILLIS)
                    .sameSite("Lax")
                    .build();
            ...
            ResponseCookie refreshCookie = ResponseCookie.from("refresh_token", refresh_token)
                    ...
                    .domain("localhost")
                    .path("/")
                    .maxAge(jwtTokenService.REFRESH_TOKEN_TIME_MILLIS)
                    .sameSite("Lax")
                    .build();
